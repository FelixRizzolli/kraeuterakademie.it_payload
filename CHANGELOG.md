...
- BIG REFACTORING: Renamed Web* collections, blocks and globals to Public* to better reflect their purpose as publicly accessible content.
...
- Simplify health endpoint
  ...
  - Now returns immediately with status 200 if the app is running
  - This prevents the healthcheck from failing during DB migrations or connection issues
